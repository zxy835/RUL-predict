...
parser.add_argument('--data', type=str,  default='NASA', help='data')
parser.add_argument('--root_path', type=str, default='./data/', help='root path of the data file')
parser.add_argument('--root_path1', type=str, default='./data/data/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='stage2.csv', help='data file')
parser.add_argument('--data_path1', type=str, default='PRED942.csv', help='data file')
...
parser.add_argument('--seq_len', type=int, default=3, help='input sequence length of Informer encoder')
...
parser.add_argument('--padding', type=int, default=1, help='padding type')
...
for ii in range(args.itr):
    ...
    setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_mx{}_{}_{}'.format(args.model, args.data, args.features, 
                ...
                args.embed, args.distil, args.mix, args.des, args.do_predict,ii)
